...
{
    defineTypeNameAndDebug(turbFlow, 0);
    addToRunTimeSelectionTable(flowModel, turbFlow, dictionary);
...
Foam::flowModels::turbFlow::turbFlow
(
    const fvMesh& mesh,
...
:
    ...
    turbulence_(incompressible::RASModel::New(U_, phi_, laminarTransport_))
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::flowModels::turbFlow::converged() const
{
...
void Foam::flowModels::turbFlow::evolve()
{
